...
export function Clients() {
  return (
    <div className=" ">
      <div className=" px-8 py-20 container mx-auto text-center border-t border-solid border-gray-900/25">
        <div className="mb-4 animate-pulse lg:text-8xl text-5xl  font-sans font-semibold" style={{ color: '#347deb' }}>
          Expertise
        </div>
        <p
