...
export function Skills() {
  return (
    <section className="px-8  ">
      <div className="container py-20 mx-auto  text-center border-t border-solid border-gray-900/25">
        {/* <Typography color="blue-gray" className="mb-2 font-bold uppercase">
          my skills
        </Typography> */}
        <Typography variant="h1" color="blue-gray" className="mb-4 animate-pulse font-semibold" style={{ color: '#347deb' }}>
          Why Hayat Pumps
        </Typography>
        {/* <Typography
          variant="lead"
